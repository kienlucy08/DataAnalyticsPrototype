...
const isConfigured = (config: PBIConfig): boolean =>
      ...
      <div className="flex flex-col items-center justify-center w-full min-h-[480px] rounded-xl border border-border bg-card gap-5">
        ...
        <div className="text-center max-w-md px-4">
          ...
          <p className="text-text-secondary text-sm leading-relaxed">
            Power BI embed is not yet configured for this role. Add your{' '}
            <code className="text-accent bg-surface px-1.5 py-0.5 rounded text-xs font-mono">reportId</code>,{' '}
            <code className="text-accent bg-surface px-1.5 py-0.5 rounded text-xs font-mono">embedUrl</code>, and{' '}
            <code className="text-accent bg-surface px-1.5 py-0.5 rounded text-xs font-mono">accessToken</code>{' '}
            to{' '}
